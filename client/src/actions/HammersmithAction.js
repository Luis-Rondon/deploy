...
const tableToApply = 'Hammersmith';

export const createHammersmith = (data) => {
...
export const getHammersmithById = (id) => {
  return new Promise((resolve, reject) => {
    newFirebase.db
      .collection(tableToApply)
      .doc(id)
...
export const getHammersmithByPatientId = (patientId, neuroMonitoringId) => {
  return new Promise((resolve, reject) => {
    newFirebase.db
      .collection(tableToApply)
      .where(
...
export const getHammersmithByPatientMonitoringId = (
  patientId,
  neuroMonitoringId,
) => {
...
export const updateHammersmithById = (id, data) => {
  return new Promise((resolve, reject) => {
    newFirebase.db
      .collection(tableToApply)
      .doc(id)
...
// export const getAllHammersmithByPatientId = (patientId) => {
//   return new Promise((resolve, reject) => {
...
export async function getAllHammersmithByPatientId(patientId) {
